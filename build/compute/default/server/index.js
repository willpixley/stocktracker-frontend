import { d as define_property, a as array_from, g as get_descriptor, s as safe_equals, r as run_all, i as index_of, b as is_array, e as equals, t as text_decoder, c as base64_decode, f as decode_pathname, h as decode_params, n as normalize_path, j as disable_search, w as writable, k as text_encoder$1, v as validate_layout_server_exports, l as validate_layout_exports, m as validate_page_server_exports, o as validate_page_exports, p as make_trackable, q as get_relative_path, u as readable, x as base64_encode, y as resolve } from './chunks/utils-368307b9.js';
import { r as render, H as HYDRATION_START, a as HYDRATION_ERROR, b as HYDRATION_END, p as push$1, s as setContext, c as pop$1 } from './chunks/index-26b49bda.js';
...
function update_effect(effect2) {
  ...
  try {
    ...
    var dep;
    if (DEV$1 && tracing_mode_flag && (effect2.f & DIRTY) !== 0 && deps !== null) ;
    if (DEV$1) ;
  } catch (error) {
        ...
        return load.call(null, {
          ...
          get data() {
            if (data === null && server_data_node?.data != null) {
              ...
              try {
                data = parse(stringify$1(server_data_node.data, reducers), revivers);
              } catch (e) {
...
async function render_page(event, event_state, page, options2, manifest, state, nodes, resolve_opts) {
  ...
  try {
    ...
    if (ssr === false && !(state.prerendering && should_prerender_data)) {
      if (DEV$1 && action_result && !event.request.headers.has("x-sveltekit-action")) ;
      return await render_response({
        branch: [],
        fetched,
        page_config: {
...
async function internal_respond(request, options2, manifest, state) {
  ...
  const event = {
    ...
    getClientAddress: state.getClientAddress || (() => {
      throw new Error(
        `${"amplify-adapter"} does not specify getClientAddress. Please raise an issue`
      );
    }),
    locals: {},
    params: {},
  ...
  async function resolve2(event2, page_nodes, opts) {
    try {
      ...
      if (state.depth === 0) {
        if (DEV$1 && event2.url.pathname === "/.well-known/appspecific/com.chrome.devtools.json") ;
        return await respond_with_error({
          event: event2,
          event_state,
          options: options2,
