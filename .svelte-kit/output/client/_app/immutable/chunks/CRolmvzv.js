...
function g(s, P = null, M) {
	...
	return new Proxy(s, {
		defineProperty(f, e, t) {
			(!('value' in t) || t.configurable === !1 || t.enumerable === !1 || t.writable === !1) && E();
			var n = i.get(e);
			return n === void 0 ? ((n = v(t.value)), i.set(e, n)) : l(n, g(t.value, y)), !0;
		},
		deleteProperty(f, e) {
			var t = i.get(e);
		...
		has(f, e) {
			...
			if (t !== void 0 || (A !== null && (!n || ((a = x(f, e)) != null && a.writable)))) {
				t === void 0 && ((t = v(n ? g(f[e], y) : u)), i.set(e, t));
				var r = o(t);
				if (r === u) return !1;
			}
			return n;
		...
		set(f, e, t, n) {
			...
			r === void 0
				? (!a || ((O = x(f, e)) != null && O.writable)) &&
					((r = v(void 0)), l(r, g(t, y)), i.set(e, r))
				: ((a = r.v !== u), l(r, g(t, y)));
