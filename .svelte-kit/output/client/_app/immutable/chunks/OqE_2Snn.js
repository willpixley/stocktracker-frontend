...
function x(n, t) {
	...
	return () => {
		...
		var d = _ || l ? document.importNode(a, !0) : a.cloneNode(!0);
		if (e) {
			var m = f(d),
				v = d.lastChild;
			r(m, v);
...
const w = '5';
typeof window < 'u' && (window.__svelte || (window.__svelte = { v: new Set() })).v.add(w);
export { L as a, r as b, N as c, M as d, x as t };
