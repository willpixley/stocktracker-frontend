<div class="w-full min-h-full bg-gray-100 ">
    <div class="pl-5">
        <h1>Limitations</h1>
        <p>Although members of congress are required to disclose all financial transactions like purchase and sale of stocks, the reporting may lag and is not always detailed. 
        </p>
