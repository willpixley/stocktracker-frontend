...
<div class='flex flex-col items-center w-full  bg-gray-100 text-gray-800 px-8'>
    <h1 class="text-3xl font-bold mt-8 mb-10">Flagged Trades</h1>
    <div class="py-5">
    <p>This system detects potential insider trading by analyzing the GICS sector of stocks traded by members of Congress and comparing them to the committees they serve on. Congressional committees oversee specific industries, 
        ...
        This allows for greater transparency and helps identify trades that may warrant further scrutiny.
    </p>
    <br>
    <p>Members of Congress have access to sensitive information through their committee work, including upcoming regulations, industry developments, and 
        ...
        concerns in congressional stock activity.
    </p>
    </div>
